...
export const rooms = [
  {
    key: "eyes" as const, name: "눈으로 find", short: "눈", location: "소강당", color: "#3568e8", soft: "#e8efff", prompt: "눈을 들어, 함께 발견해요", mark: "◉", emblem: "/emblems/eyes.jpg",
  ...
  {
    key: "sound" as const, name: "소리로 find", short: "소리", location: "000호", color: "#e9542f", soft: "#fff0eb", prompt: "귀 기울일 때 들리는 것들", mark: ")))", emblem: "/emblems/sound.jpg",
  ...
  {
    key: "body" as const, name: "몸으로 find", short: "몸", location: "외부", color: "#1d9a6c", soft: "#e5f7ef", prompt: "움직이며 하나가 되는 시간", mark: "↗", emblem: "/emblems/body.jpg",
  ...
  {
    key: "heart" as const, name: "마음으로 find", short: "마음", location: "000호", color: "#8b54c6", soft: "#f2eafd", prompt: "마음 깊은 곳을 천천히 바라봐요", mark: "♡", emblem: "/emblems/heart.jpg",
  ...
  {
    key: "grace" as const, name: "은혜로 find", short: "은혜", location: "000호", color: "#d89b18", soft: "#fff5d8", prompt: "선물처럼 주어진 오늘을 기억해요", mark: "✦", emblem: "/emblems/grace.jpg",
