...
export const rooms = [
  ...
  {
    key: "sound" as const, name: "소리로 find", short: "소리", location: "211호", color: "#e9542f", soft: "#fff0eb", prompt: "귀 기울일 때 들리는 것들", mark: ")))", emblem: "/emblems/sound.jpg", collectionAsset: "/collection/sound-piece.webp", collectionSize: [600, 600] as const, collectionPosition: { left: 19.9, top: 60.3, width: 10, rotate: 38 }, artifactName: "열린 미로 벽",
    navigation: { floor: "2f", locationId: "211" } satisfies RoomNavigation,
  ...
  {
    key: "heart" as const, name: "마음으로 find", short: "마음", location: "221호", color: "#8b54c6", soft: "#f2eafd", prompt: "마음 깊은 곳을 천천히 바라봐요", mark: "♡", emblem: "/emblems/heart.jpg", collectionAsset: "/collection/heart-piece.webp", collectionSize: [600, 600] as const, collectionPosition: { left: 2.15, top: 70.1, width: 25.9, rotate: 0 }, artifactName: "나침반",
    navigation: { floor: "2f", locationId: "221" } satisfies RoomNavigation,
  ...
  {
    key: "grace" as const, name: "은혜로 find", short: "은혜", location: "202호", color: "#d89b18", soft: "#fff5d8", prompt: "선물처럼 주어진 오늘을 기억해요", mark: "✦", emblem: "/emblems/grace.jpg", collectionAsset: "/collection/grace-piece.webp", collectionSize: [600, 600] as const, collectionPosition: { left: 38.3, top: 36.1, width: 26.7, rotate: 0 }, artifactName: "십자가",
    navigation: { floor: "2f", locationId: "202" } satisfies RoomNavigation,
...
export type TeamState = {
  ...
  previousRoom: RoomKey | null;
  previousRoomExitedAt: string | null;
